...
/***************************** Vertex Buffer *****************************/
VertexBuffer::VertexBuffer(const void* data, VkDeviceSize size, VkDevice device, VkPhysicalDevice physicalDevice, VkQueue graphicsQueue, VkCommandPool commandPool): device{device} {
    ...
    Buffer::CreateBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, buffer, memory, device, physicalDevice);
    Buffer::CopyBuffer(stagingBuffer, buffer, bufferSize, device, graphicsQueue, commandPool);
...
/***************************** Index Buffer *****************************/
IndexBuffer::IndexBuffer(const void* data, VkDeviceSize size, VkDevice device, VkPhysicalDevice physicalDevice, VkQueue graphicsQueue, VkCommandPool commandPool) : device{device}, count{static_cast<UINT>(size / sizeof(unsigned short))} {
    VkDeviceSize bufferSize = size;
    ...
    Buffer::CreateBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, buffer, memory, device, physicalDevice);
...
/***************************** Constant Buffer *****************************/
ConstantBuffer::ConstantBuffer(VkDeviceSize size, VkDevice device, VkPhysicalDevice physicalDevice) : device{device} {
    VkDeviceSize bufferSize = size;

    Buffer::CreateBuffer(bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, buffer, uniformBufferMemory, device, physicalDevice);
